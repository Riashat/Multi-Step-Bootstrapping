...
def double_q_learning_random_policy(env, num_episodes, discount_factor=1.0, alpha = 0.5, epsilon = 0.1):
	...
	#choose a based on Q_A + Q_B
	policy = create_random_policy(Total_Q)
...
#     plt.title("Comparing SARSA, Q-Learning and Double Q-Learning")
#     plt.show()
